...
// Gambar ikan nila dari Wikimedia yang stabil
const IMGS = [
  'https://upload.wikimedia.org/wikipedia/commons/thumb/3/30/Oreochromis_niloticus.jpg/480px-Oreochromis_niloticus.jpg',
  'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2e/Mozambique_tilapia_at_flinders_ranges_waterhole.jpg/480px-Mozambique_tilapia_at_flinders_ranges_waterhole.jpg',
  'https://upload.wikimedia.org/wikipedia/commons/thumb/5/5a/Oreochromis-niloticus-whole.jpg/480px-Oreochromis-niloticus-whole.jpg',
  'https://upload.wikimedia.org/wikipedia/commons/thumb/1/1b/Oreochromis_karongae_imported_from_iNaturalist_photo_33068038_on_8_March_2020.jpg/480px-Oreochromis_karongae_imported_from_iNaturalist_photo_33068038_on_8_March_2020.jpg',
]
...
export default function ProductCard({ product }) {
  ...
  const variants = product.variants || [{ size: product.size || '2-3 cm', price: product.price }]
  ...
  const imgSrc = imgErr
    ? IMGS[0]
    : (product.image?.startsWith('http') ? product.image : IMGS[(product.id - 1) % IMGS.length])
