...
useEffect(() => {
  ...
  return (
    <>
      {/* ═══════════════════════════════════════════
          HERO — full width background, teks centered
      ═══════════════════════════════════════════ */}
      <section
  style={{
    position: 'relative',
  ...
  >
    ...
    <div
      style={{
        ...
        inset: 0,
        background:
          'linear-gradient(135deg, rgba(30,58,138,0.82) 0%, rgba(37,99,235,0.72) 100%)',
      }}
    />
  </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '3rem', alignItems: 'center' }}
            ...
            <div>
              ...
              <div style={{ display: 'flex', gap: '0.75rem', flexWrap: 'wrap' }}>
                ...
                <a href="https://wa.me/6281212289098" target="_blank" rel="noreferrer" className="btn-wa">
                  💬 Hubungi via WA
                </a>
              </div>

              {/* Stats */}
              <div style={{ display: 'flex', gap: '2.5rem', marginTop: '2rem', paddingTop: '1.75rem', borderTop: '1px solid rgba(255,255,255,0.15)' }}>
        ...
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '3rem', alignItems: 'center' }}
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.875rem' }}>
              {[
                { icon: '📍', title: 'Alamat', val: 'Jl. Raya Dramaga, Bogor, Jawa Barat' },
                { icon: '📞', title: 'Telepon/WA', val: '+62 812-1228-9098' },
